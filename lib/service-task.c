			  ...
			  gpointer cb_user_data)
{
	...
	task = g_new0(dlr_service_task_t, 1);
...
void dlr_service_task_begin_action_cb(GUPnPServiceProxy *proxy,
				      ...
				      gpointer user_data)
{
	dlr_service_task_t *task = (dlr_service_task_t *)user_data;
...
void dlr_service_task_process_cb(dleyna_task_atom_t *atom, gpointer user_data)
{
	...
	dlr_service_task_t *task = (dlr_service_task_t *)atom;
